...
class TransactionRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transaction_record" do
    assert_difference("TransactionRecord.count") do
      post transaction_records_url, params: { transaction_record: { paymentReference: @transaction_record.paymentReference, status: @transaction_record.status, transaction_id: @transaction_record.transaction_id } }, as: :json
    end
  ...
  test "should update transaction_record" do
    patch transaction_record_url(@transaction_record), params: { transaction_record: { paymentReference: @transaction_record.paymentReference, status: @transaction_record.status, transaction_id: @transaction_record.transaction_id } }, as: :json
    assert_response :success
  end
