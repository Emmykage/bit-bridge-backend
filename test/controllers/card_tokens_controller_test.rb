...
class CardTokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create card_token" do
    assert_difference("CardToken.count") do
      post card_tokens_url, params: { card_token: { order_item_id: @card_token.order_item_id, reveal: @card_token.reveal, token: @card_token.token } }, as: :json
    end
  ...
  test "should update card_token" do
    patch card_token_url(@card_token), params: { card_token: { order_item_id: @card_token.order_item_id, reveal: @card_token.reveal, token: @card_token.token } }, as: :json
    assert_response :success
  end
