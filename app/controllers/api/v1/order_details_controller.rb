class Api::V1::OrderDetailsController < ApplicationController
  ...
  private
    ...
    def order_detail_params
      params.require(:order_detail).permit(:total_amount, :extra_info, :status, :payment_method, :viewed, :net_total,:order_type, :proof, order_items_attributes: %i[quantity amount provision_id product_id currency ])
    end
end
