...
User.find_or_create_by!(email: "emmiemenz@gmail.com") do |user|
  ...
  products =[
    ...
    {
      provider: "xbox",
      provision: "Xbox USD International",
      min_value: 5.0,
      max_value: 50000.0,
      currency: "NGN",
      rate: 4.7,
    ...
    },
    {
      ...
      provision: "Cherry credits Multi-Game",
      min_value: 54.0,
      max_value: 80.0,
      currency: "USD",
      rate: 4.7,
      image: "/images/gift-cards/cherry-credits-international.webp",
      description: "Unlock limitless gaming potential with your Bitcoin, ETH or Tether through Cherry Credits Gift Card! Cherry Credits (CC) is a virtual currency that enables you to buy and enjoy over 1,000 games and digital content for popular games such as Black Desert, Dragon Nest, and Travian:Legends, as well as serving as a payment method on Steam and Ubisoft Store.",
    ...
    },
    {
      ...
      description: "Kinguin Games Store offers a vast selection of over 95,000 games, DLCs, software, and unique skins for gamers worldwide. Buy Kinguin Games Store International with Bitcoin, Lightning, Ethereum, Binance Pay, USDT, USDC, or from 6000+ cryptos on LI.FI. Instant email delivery. No account required. Start living on crypto!",
      info: "This gift card is redeemable on the e-commerce platform & at the physical store",
      category: "gift card"
    },
    {
