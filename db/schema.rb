...
ActiveRecord::Schema[7.1].define(version: 2025_11_20_074728) do
  ...
  create_table "card_holders", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "address"
    t.string "postal_code"
    t.string "bvn"
    t.string "house_no"
    ...
    t.string "first_name"
    t.string "last_name"
    t.index ["unique_card_holder_id"], name: "index_card_holders_on_unique_card_holder_id", unique: true
    t.index ["wallet_id"], name: "index_card_holders_on_wallet_id"
  end
  ...
  create_table "cardholders", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "address"
    t.string "postal_code"
    t.string "bvn"
    t.string "house_no"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["wallet_id"], name: "index_cardholders_on_wallet_id"
  end
  ...
  create_table "cards", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "phone"
    t.string "postal"
    t.uuid "card_holder_id", null: false
    t.index ["card_holder_id"], name: "index_cards_on_card_holder_id"
  end
  ...
  add_foreign_key "card_holders", "wallets"
  add_foreign_key "card_tokens", "order_items"
  add_foreign_key "cardholders", "wallets"
  add_foreign_key "cards", "card_holders"
